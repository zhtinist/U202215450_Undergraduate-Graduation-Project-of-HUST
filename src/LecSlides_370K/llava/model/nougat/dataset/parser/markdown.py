...
from llava.model.nougat.dataset.utils import normalize_tex
from llava.model.nougat.dataset.parser.document import *
from llava.model.nougat.dataset.parser.latexml_parser import _clean_html_whitespace
